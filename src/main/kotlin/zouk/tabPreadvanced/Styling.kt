    ...
    with(dsl) {
        section("Styling") {
            subSection("Head Movements") {
                html {
                    youtube(
                        "UN52iFqLLL8?si=9wLTJ5K_DhdYBu2M",
                        "5 minutes explanation and demonstration of possible application and combination"
                    )
                    p {
                        +"For the start, it is nice to explore more elaborate head movements while either doing the ";ref(
                        ZoukRef.Balao
                    );+", ";ref(ZoukRef.Rotisserie);+" or a Tilted Turn. "; br
