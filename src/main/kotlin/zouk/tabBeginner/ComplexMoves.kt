    ...
    with(dsl) {
        section("Complex Moves") {
            subSection("Viradinha") {
                // =====================================================================================================
                content {
                    p { +"\"Virada\" means \"turn\" in Portuguese, and the diminutive \"inha\" means \"little\". "; br
                    ...
                    p { +"The hand contact is completely unnecessary; that is a general rule, that we don't lead by "
                    ...
                    p { +"A "; b { +"variation" }; +" is for example a \"turned Viradinha\": Instead of the follower simple doing a 180-degrees"
                    ...
                    p { +"Another variation is, once opened up in Viradinha, simply go forward and backward "
            ...
            subSection("Lunge") {
                ...
                content {
                    ...
                    p { +"It can be used for playing with musicality, choosing to slow much down, while followers wait the lead to exit the lunge; or keeping it short. "
                    ...
                    p { +"You can also do a lunge hesitate turn: From a basic, start like with the Viradinha, step to the "
                        +"side, pivot on the spot, lunge, and then it is possible to "; i{+"optionally"}; +" do a \"Hesitate\" "
                        +"(shifting the weight left and right, with a clear, good connection) before going into a simple turn." }
            ...
            subSection("Soltinho") {
                // =====================================================================================================
                content {
                    p { +"The name comes from the Portuguese word \"solta\", meaning free or loose. "
                    ...
                    p { +"The footwork is more complicated and also used in more complicated, other moves. "
                        +"It is recommended to practice it by yourself! First going linear, then in circles." }
                    p { +"Enter it by doing a lateral step, when moving to the left, keep the arms wide open to give a clear signal to go into circular step. "
                    ...
                    youtube("HnxtpvG_nDM?si=a9t3PKf5i5l9PDqO", "Soltinho footwork (linear/circular) - enter and exit from lateral")
            ...
            subSection("Bonus Pushed Turn") {
                ...
                content {
                    ...
                    p { +"From lateral while she is walking to the right, prepare the right hand, raise up head height, palms touching each other. "
                    ...
                    p { +"Keep the right arm up, indicating that the follower should keep on spinning (ad infinitum). "
                        ...
                        +"Pull her back and let her do a free spin (similar to Yoyo, really throw the right hand outwards, to indicate she shall spin), and finally going back to basic again. "
                    }
                    youtube("ix1h05vJhxo?si=v9xYMRlW30M8T4ya", "From lateral a pushed turn, free-spin and back to basic")
                }
            }
        }
    }
